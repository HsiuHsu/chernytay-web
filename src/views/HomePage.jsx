...
const ServiceInfo = ({ classes }) => (
    <Box sx={{ display: 'flex' }}>
        <Box sx={{ width: '100%', margin: '120px 0', position: 'relative', background: { xs: 'rgb(252, 252, 246)', lg: 'linear-gradient(90deg, white 50%, rgb(252, 252, 246) 0%)' } }}>
            <ContainerStyles disableGutters>
                <Typography className={classes.bgTitle} sx={{ right: 0, transform: { sm: 'translateX(48px)', lg: 'translateX(72px)' } }}>Service</Typography>
                <Grid container sx={{
                    ...
                    }}>
                        {
                            ['設計規劃', '工程施工', '維修服務', '保養服務', '節能改善'].map(item => (
                                <Grid item xs={6} sm={3} md={0} key={item} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                    <img src={require('../public/img/svg/service/' + item + '.svg')} alt={item} />
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            <Box sx={{ width: '100%', margin: '120px 0', position: 'relative', background: { xs: 'rgb(245, 255, 235)', lg: 'linear-gradient(-90deg, white 50%, rgb(245, 255, 235) 0%)' } }}>
                <ContainerStyles disableGutters>
                    <Typography className={classes.bgTitle} sx={{ zIndex: 10, left: 24 }}>Work</Typography>
                    <Grid container sx={{
        ...
        <Box sx={{ display: 'flex', paddingTop: 25, paddingBottom: 25 }}>
            <Box sx={{
                ...
                <ContainerStyles disableGutters sx={{ width: '100%' }}>
                    <Stack spacing={3} sx={{
                        width: { xs: '100%', xl: 936 }, position: 'relative', paddingY: 9.5, paddingX: { sm: 9, lg: 12 }, margin: { xl: '0 auto' }, background: 'var(--primary99)',
                        ...
                        <Typography className={classes.bgTitle} sx={{
                            position: 'absolute', zIndex: 10, left: { xs: 'calc(50% + 1rem)', sm: 'calc(50% + 2.25rem)', md: 'calc(50% + 3rem)', xl: 'calc(50% + 5rem)' },
                            bottom: { xs: '-64px', sm: '-80px', md: '-96px', lg: '-136px' }, top: 'auto !important',
                            letterSpacing: { md: '3rem !important', xl: '5rem !important' }, transform: 'translate(-50%,-50%)'
